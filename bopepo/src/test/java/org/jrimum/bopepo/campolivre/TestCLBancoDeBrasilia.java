...
public class TestCLBancoDeBrasilia extends AbstractCampoLivreBaseTest<CLBancoDeBrasilia> {
	...
	public void setUp() {
		...
		assertEquals(Integer.valueOf (4), titulo.getParametrosBancarios().getValor(CHAVE_ASBACE_DIGITO1));
		assertEquals(Integer.valueOf (5), titulo.getParametrosBancarios().getValor(CHAVE_ASBACE_DIGITO2));
	}
	...
	public void seGeraCorretoParaCarteiraComRegistro(){
		...
		assertEquals(Integer.valueOf (3), titulo.getParametrosBancarios().getValor(CHAVE_ASBACE_DIGITO1));
		assertEquals(Integer.valueOf (1), titulo.getParametrosBancarios().getValor(CHAVE_ASBACE_DIGITO2));
	}
